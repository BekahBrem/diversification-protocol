...
class TestExperiment(unittest.TestCase):
    ...
    def test_simulation_creation(self):
        ...
        testExperiment = Experiment(test_agents, test_colours, test_weights_dict)
    ...
    def test_perform_steps(self):
        ...
        #Assert total weight calculated correctly
        self.assertEqual(22, len(testExperiment.x_values))
        self.assertEqual(22, len(testExperiment.y_values[0]))
